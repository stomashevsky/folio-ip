...
function InquiryTemplateDetailContent() {
  ...
  if (!isNew && !existing) {
    return <NotFoundPage section="Inquiry Templates" backHref="/inquiries/templates" entity="Inquiry template" />;
  }
  ...
  function save(formOverride?: InquiryFlowForm) {
    ...
    if (isNew) {
      ...
      router.replace(`/inquiries/templates/${created.id}`);
    } else {
  ...
  function handleDelete() {
    ...
    router.push("/inquiries/templates");
  }
  ...
  const backHref = "/inquiries/templates";
