...
import type { InquiryTypeRow } from "@/lib/data";
...
type SortKey = "label" | "created" | "completionRate" | "approvalRate";
        ...
        <table className="-mb-px w-full">
          <thead>
            <tr className="border-b border-[var(--color-border)]">
              <SortableTh onClick={() => handleSort("label")} sortIcon={<SortIcon active={sortKey === "label"} dir={sortDir} />}>Template</SortableTh>
              ...
              <SortableTh onClick={() => handleSort("completionRate")} align="right" sortIcon={<SortIcon active={sortKey === "completionRate"} dir={sortDir} />}>Completion Rate</SortableTh>
          ...
          <tbody>
            {sorted.map((row) => (
              <tr key={row.typeKey} className="border-b border-[var(--color-border)]">
                ...
                <td className="px-4 py-2.5 text-right">
                  <span className="text-sm text-[var(--color-text)]">{row.completionRate}%</span>
                </td>
                <td className="px-4 py-2.5 text-right">
