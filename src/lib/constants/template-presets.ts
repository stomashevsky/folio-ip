...
export const VERIFICATION_TEMPLATE_PRESETS: TemplatePreset<"verification">[] = [
  {
    ...
    defaults: {
      ...
      type: "government_id",
      checks: [
        { name: "Allowed country", category: "validity", required: true, enabled: true },
        { name: "Allowed ID type", category: "validity", required: true, enabled: true },
        { name: "Barcode", category: "validity", required: false, enabled: true },
        { name: "Compromised submission", category: "fraud", required: true, enabled: true },
        { name: "Expiration", category: "validity", required: true, enabled: true },
        { name: "Fabrication", category: "fraud", required: true, enabled: true },
        { name: "Government ID", category: "validity", required: true, enabled: true },
        { name: "ID image tampering", category: "fraud", required: true, enabled: true },
        { name: "Portrait clarity", category: "biometrics", required: false, enabled: true },
        { name: "Processable submission", category: "validity", required: true, enabled: true },
      ],
  ...
  },
  {
    ...
    defaults: {
      ...
      type: "selfie",
      checks: [
        { name: "Liveness", category: "biometrics", required: true, enabled: true },
        { name: "Face comparison", category: "biometrics", required: true, enabled: true },
        { name: "Center present", category: "biometrics", required: false, enabled: true },
        { name: "Selfie pose", category: "biometrics", required: false, enabled: true },
        { name: "Selfie suspicious", category: "fraud", required: false, enabled: true },
      ],
  ...
  },
  {
    ...
    defaults: {
      ...
      type: "document",
      checks: [
        { name: "Document extraction", category: "validity", required: true, enabled: true },
        { name: "Document tampering", category: "fraud", required: true, enabled: true },
        { name: "Document type detection", category: "validity", required: false, enabled: true },
        { name: "Document valid", category: "validity", required: true, enabled: true },
      ],
  ...
  },
  {
    ...
    defaults: {
      ...
      type: "database",
      checks: [
        { name: "Database name match", category: "validity", required: true, enabled: true },
        { name: "Database date of birth match", category: "validity", required: true, enabled: true },
        { name: "Database address match", category: "validity", required: false, enabled: true },
        { name: "Database SSN match", category: "validity", required: false, enabled: false },
      ],
  ...
  },
  {
    ...
    defaults: {
      ...
      type: "aamva",
      checks: [
        { name: "AAMVA name match", category: "validity", required: true, enabled: true },
        { name: "AAMVA date of birth match", category: "validity", required: true, enabled: true },
        { name: "AAMVA license number match", category: "validity", required: true, enabled: true },
        { name: "AAMVA issuing authority match", category: "validity", required: true, enabled: true },
        { name: "AAMVA expiration check", category: "validity", required: true, enabled: true },
      ],
      settings: { allowedCountries: ["US"], maxRetries: 2, captureMethod: "auto" },
    },
  },
  {
    ...
    defaults: {
      ...
      type: "email_address",
      checks: [
        { name: "Email deliverable", category: "validity", required: true, enabled: true },
        { name: "Email domain valid", category: "validity", required: true, enabled: true },
        { name: "Email not disposable", category: "fraud", required: true, enabled: true },
        { name: "Email age check", category: "fraud", required: false, enabled: true },
      ],
  ...
  },
  {
    ...
    defaults: {
      ...
      type: "phone_number",
      checks: [
        { name: "Phone number valid", category: "validity", required: true, enabled: true },
        { name: "OTP verified", category: "validity", required: true, enabled: true },
        { name: "Phone not VoIP", category: "fraud", required: false, enabled: true },
        { name: "Carrier lookup", category: "validity", required: false, enabled: true },
      ],
