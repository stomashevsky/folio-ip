...
# What is the Case Markdown module?[](#what-is-the-case-markdown-module)
...
![markdown](../images/markdown_8e4319f1d4ed.png)

The **Case Markdown module** is often used to include directions for those reviewing cases or to create titled sections for further organizing the case layout (i.e. this section is about an end user's location details, this other section is about the end user's verification attempts).

# How do you add a Case Markdown module?[](#how-do-you-add-a-case-markdown-module)
...
![markdownmodule](../images/markdownmodule_ee65e2cc550f.png)

6.  Click on the **Markdown module** on the right toolbar you can customize how information is displayed on the module.
...
![markdownsettinginput](../images/markdownsettinginput_21e3215ffc93.png)

1.  To create a line break, press Enter twice.
...
1.  **Basic** visibility allows you to set rules on the **Markdown module** to determine when it will be visible. You can read more about **Basic visibility configuration** below.
...
## Case Markdown module component by plan[](#case-markdown-module-component-by-plan)

|  | Startup Program | Essential Plan | Growth Plan | Enterprise Plan |
| --- | --- | --- | --- | --- |
| Case Markdown module component | Available | Available | Available | Available |
