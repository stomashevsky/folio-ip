# Inquiries: Radio Group component

# What is the Inquiry Radio Group component?[](#what-is-the-inquiry-radio-group-component)

**Radio Group** is an Inquiry screen component that adds a group of interactive components that allow a user to select an option from a predefined set, only a single option can be made.

![radiogroup](../images/RadioGroupComponent_4d3fd47671e7.png)

A **Radio Group** component is ideal for scenarios like answering a multiple choice questions or selecting a preference.

# How do you add an Inquiry Radio Group component?[](#how-do-you-add-an-inquiry-radio-group-component)
...
4.  In the Left Panel, click **Component Library** and search for ‘**Radio Group**’.
5.  Drag and drop the Radio Group component into your screen, and reposition it by dragging it around.
6.  Click on the Radio Group component, and go to **Properties** in the Right Panel.
    1.  (Optional) Add customized **validations.** Learn more about **Validations** below.
    2.  (Optional) Add a customized **label** and **translations**:
        1.  Edit the text in the **Label** box. The **Label** is a text element displayed above the Radio Group component to describe its purpose, such as “Select Country” helping users understand what information to provide.
...
7.  In the **[Fields](./5rT2Llik2kUvJTXKapZb8c.md)** tab, you can set up and customize the behavior of the Radio Group component.
...
![radiogroupoption](../images/radiogroupoption_45e3bf840cb6.png)
...
Validation rules can be set on a Radio Group component to ensure that the entered data is a valid. This can prevent errors such as invalid inputs, and can ensure only usable inputs are submitted.

The **Error message** can be edited to provide the user with more information on why the Radio Group selection is not valid. Translations for the error message can be added by clicking **Edit translations.** You can **Translate All** or **Translate** individual languages, manually or automatically. If you don’t set translations, you’ll be prompted to do so upon **Publishing** the template.
...
1.  Click on the Radio Group component, and go to **Logic** in the Right Panel.
...
Persona provides you with the ability to add logic to a Radio Group component. For example, a component may only become visible to a user if certain conditions are met. On the **Logic** tab, there are two options for logic rules:
...
1.  Click on the Radio component, and go to **Logic** in the Right Panel.
...
## Radio Group component by plan[](#radio-group-component-by-plan)

|  | Startup Program | Essential Plan | Growth Plan | Enterprise Plan |
| --- | --- | --- | --- | --- |
| Radio Group component | Available | Available | Available | Available |
| Validations for Radio Group component | Available | Available | Available | Available |
| Translations for Radio Group component | Available | Available | Available | Available |
| Logic for Radio Group component | Not Available | Not Available | Available as part of Inquiries Enhanced | Available as part of Inquiries Enhanced |
