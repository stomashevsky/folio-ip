# Understanding Business Website Verification results[](#understanding-business-website-verification-results)

## Overview[](#overview)

The Business Website Verification (BWV) verifies the validity and legitimacy of a business's website during the Know Your Business process. For more details, see the [Business Website Verification overview](./6YMwMNVZpOYO4n6bpUhokY.md).

This page examines an example of a Business Website Verification and guides you through the results. You'll learn how to interpret Verification checks and understand why they passed or failed.
...
## Example Business Website Verification result[](#example-business-website-verification-result)

As an example, we'll look at a Business Website Verification. We'll walk through the example Verification below, section by section.

![BusinessWebsiteVerification](../images/BusinessWebsiteVerification_383db00de2e1.png)
...
When viewing a Business Website Verification run, you’ll first see the overall Verification result. In this example, the Business Website Verification **passed**.
...
“Website URL” refers to the website URL submitted.

### Business name[](#business-name)

“Business name” refers to the the business name submitted.
...
![BusinessWebsiteVerificationCheck](../images/BusinessWebsiteVerificationCheck_ee0c621bd9a6.png)
