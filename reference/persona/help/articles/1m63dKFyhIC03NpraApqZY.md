# Inquiries: Country Select component

# What is the Inquiry Country Select component?[](#what-is-the-inquiry-country-select-component)

**Country Select** is an Inquiry screen component that allows a user to choose from a predefined list, ensuring standardized and accurate country selection.

![CountrySelect](../images/CountrySelectComponent_994870855b64.png)

This component is useful for flows requiring country-specific experiences or for collecting location-specific information.

# How do you add an Inquiry Country Select component?[](#how-do-you-add-an-inquiry-country-select-component)
...
4.  In the Left Panel, click **Component Library** and search for ‘**Country Select**’.
5.  Drag and drop the Country Select component into your screen, and reposition it by dragging it around.
6.  Click on the Country Select component, and go to **Properties** in the Right Panel.
    1.  (Optional) Under **Settings**, you can customize the Countries a user can select from. All countries will be selected by default.
        1.  The user’s country will be prefilled based on the user’s IP address. If you would like to disable this feature, click the toggle button “Disable location based prefill.”
    2.  (Optional) Add customized **validations.** Learn more about **Validations** below.
    3.  (Optional) Add a customized **label**, **placeholder** and **translations**:
        1.  Edit the text in the **Label** box. The **Label** is a text element displayed above the Country Select component to describe its purpose, such as “Select Country” helping users understand what information to provide.
        2.  Edit the text in the **Placeholder** box. The **Placeholder** displays temporary text inside the Country Select component, such as “Country” offering an example or guidance on the expected format until the user enters their own input.
...
7.  In the **[Fields](./5rT2Llik2kUvJTXKapZb8c.md)** tab, you can set up and customize the behavior of the Country Select component.
...
Validation rules can be set on a Country Select component to ensure that the entered data is a properly formatted and is a valid country.

The **Error message** can be edited to provide the user with more information on why the country is not valid. Translations for the error message can be added by clicking **Edit translations.** You can **Translate All** or **Translate** individual languages, manually or automatically. If you don’t set translations, you’ll be prompted to do so upon **Publishing** the template.
...
1.  Click on the Country Select component, and go to **Logic** in the Right Panel.
...
Persona provides you with the ability to add logic to a Country Select component. For example, a component may only become visible to a user if certain conditions are met. On the **Logic** tab, there are two options for logic rules:
...
## Country Select component by plan[](#country-select-component-by-plan)

|  | Startup Program | Essential Plan | Growth Plan | Enterprise Plan |
| --- | --- | --- | --- | --- |
| Country Select component | Available | Available | Available | Available |
| Translations for Country Select component | Available | Available | Available | Available |
| Logic for Country Select component | Not Available | Not Available | Available as part of Inquiries Enhanced | Available as part of Inquiries Enhanced |
