# Inquiries: Number Input component

# What is the Inquiry Number Input component?[](#what-is-the-inquiry-number-input-component)

**Number Input** is an Inquiry screen component that adds a form component designed for users to enter numeric values.

![numberinput](../images/NumberInputComponent_4ec02237baf2.png)

The **Number Input** component is useful for collecting ages, quantities, prices, or any data that requires numerical formatting.

# How do you add an Inquiry Number Input component?[](#how-do-you-add-an-inquiry-number-input-component)
...
4.  In the Left Panel, click **Component Library** and search for ‘**Number Input**’.
5.  Drag and drop the Number Input component into your screen, and reposition it by dragging it around.
6.  Click on the Number Input component, and go to **Properties** in the Right Panel.
    1.  (Optional) Under **Settings**, you can customize **Validations.** Default validations are included to only allow numerical numbers as input. You can learn more about **Validations** below.
    2.  (Optional) Add a customized **label**, **placeholder** and **translations**:
        1.  Edit the text in the **Label** box. The **Label** is a text element displayed above the Number Input component to describe its purpose, such as “Enter your Age” helping users understand what information to provide.
        2.  Edit the text in the **Placeholder** box. The **Placeholder** displays temporary text inside the Number input component, such as “40” offering an example or guidance on the expected format until the user enters their own input.
...
7.  In the **[Fields](./5rT2Llik2kUvJTXKapZb8c.md)** tab, you can set up and customize the behavior of the Number Input component.
    ...
    2.  **Field:** Select which field will store the number value. For example, choose an age field if users will be entering their age.
...
Validation rules can be set on a Number Input field to ensure that the entered data is a properly formatted and is a valid number. This can prevent errors such as an incomplete numerical value, decimal formatting issues, or values outside of acceptable ranges. This ensures that only valid numbers are submitted.

The **Error message** can be edited to provide the user with more information on why the Number is not valid. Translations for the error message can be added by clicking **Edit translations.** You can **Translate All** or **Translate** individual languages, manually or automatically. If you don’t set translations, you’ll be prompted to do so upon **Publishing** the template.
...
1.  Click on the Number Input component, and go to **Logic** in the Right Panel.
...
Persona provides you with the ability to add logic to a Number Input component. For example, a component may only become visible to a user if certain conditions are met. On the **Logic** tab, there are two options for logic rules:
...
## Number Input component by plan[](#number-input-component-by-plan)

|  | Startup Program | Essential Plan | Growth Plan | Enterprise Plan |
| --- | --- | --- | --- | --- |
| Number Input component | Available | Available | Available | Available |
| Validations for Number Input component | Available | Available | Available | Available |
| Translations for Number Input component | Available | Available | Available | Available |
| Logic for Number Input component | Not Available | Not Available | Available as part of Inquiries Enhanced | Available as part of Inquiries Enhanced |
