# Inquiries: Multi Select component

# What is the Inquiry Multi Select component?[](#what-is-the-inquiry-multi-select-component)

**Multi Select** is an Inquiry screen component that allows a user to choose multiple options from a predefined list.

![multiselectcomponent](../images/MultiSelectComponent_91eff41b1f99.png)

An **Multi Select** component is ideal for scenarios where multiple selections are needed, such as selecting skills in a profile.

# How do you add an Inquiry Multi Select component?[](#how-do-you-add-an-inquiry-multi-select-component)
...
4.  In the Left Panel, click **Component Library** and search for ‘**Multi Select**’.
5.  Drag and drop the Multi Select component into your screen, and reposition it by dragging it around.
6.  Click on the Multi Select component, and go to **Properties** in the Right Panel.
    ...
    2.  (Optional) Add a customized **label**, **placeholder** and **translations**:
        1.  Edit the text in the **Label** box. The **Label** is a text element displayed above the Multi Select component to describe its purpose, such as “Select Country” helping users understand what information to provide.
        2.  Edit the text in the **Placeholder** box. The **Placeholder** displays temporary text inside the Multi Select input component, such as “Country” offering an example or guidance on the expected format until the user enters their own input.
...
7.  In the **[Fields](./5rT2Llik2kUvJTXKapZb8c.md)** tab, you can set up and customize the behavior of the Multi Select component.
...
![EditOptions](../images/EditOptions_d26d5bac9d53.png)
...
Validation rules can be set on a Multi Select component to ensure that the entered data is a properly formatted and is a valid selection. This can prevent errors such as an invalid input, and can ensure only usable selections are submitted.

The **Error message** can be edited to provide the user with more information on why the Multi Select selection is not valid. Translations for the error message can be added by clicking **Edit translations.** You can **Translate All** or **Translate** individual languages, manually or automatically. If you don’t set translations, you’ll be prompted to do so upon **Publishing** the template.
...
1.  Click on the Multi Select component, and go to **Logic** in the Right Panel.
...
## Multi Select component by plan[](#multi-select-component-by-plan)

|  | Startup Program | Essential Plan | Growth Plan | Enterprise Plan |
| --- | --- | --- | --- | --- |
| Multi Select component | Available | Available | Available | Available |
| Validations for Multi Select component | Available | Available | Available | Available |
| Translations for Multi Select component | Available | Available | Available | Available |
| Logic for Multi Select component | Not Available | Not Available | Available as part of Inquiries Enhanced | Available as part of Inquiries Enhanced |
