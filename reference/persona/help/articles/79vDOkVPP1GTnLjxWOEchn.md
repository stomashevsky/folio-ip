# What to Expect When Verifying Your Identity with Persona and Okta
...
# How does Okta partner with Persona?[](#how-does-okta-partner-with-persona)

Okta and Persona have teamed up to provide a secure and smooth identity verification experience. This partnership allows Okta to maintain high safety, compliance, and user experience standards by using Persona’s verification tools.

# Why am I being redirected to Persona?[](#why-am-i-being-redirected-to-persona)
...
![Government ID Verification](../images/Screenshot_2025-06-10_at_1.17.50_C3_A2__PM_3678ec2a42fc.png)

2.  Take a selfie to confirm you’re the person on the ID.

![Selfie Verification Example](../images/Screenshot_2025-06-10_at_1.18.23_C3_A2__PM_4778154f9179.png)
...
Note: This article is intended for individuals completing a Persona verification flow after being redirected from Okta. For more technical or configuration questions, please refer to our Help Center or contact your service provider.
