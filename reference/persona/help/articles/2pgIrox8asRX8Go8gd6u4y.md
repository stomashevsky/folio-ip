# Inquiries: Text component

# What is the Inquiry Text component?[](#what-is-the-inquiry-text-component)

**Text** is an Inquiry screen component that adds a text box to the screen. You can customize its appearance, set translations, and define logic that governs when it appears.

![text](../images/Screenshot_2025-10-31_at_1.35.57_C3_A2__PM_71acb8a14055.png)

Every screen a user interacts with should include concise, descriptive text to provide context. Examples include a brief explanation of a form’s purpose (”Enter your contact information below”), instructions for completing a task (”Upload an image to submit”), or a confirmation message (”Your changes have been saved”). Clear text helps users understand what is expected and enhances their experience.

# How do you add an Inquiry Text component?[](#how-do-you-add-an-inquiry-text-component)
...
4.  In the Left Panel, click the **+** icon to open the Component Library and search for ‘**Text**’.
...
![text-translation](../images/text-translation_a7a5d1b0f3c2.png)
...
Margins can be adjusted on all four sides of the Text component (top, left, bottom, right) to control the spacing between it and other elements on the screen. For instance, increasing the top margin can create more breathing room above the **Text**, while adjusting the bottom margin can ensure consistent spacing with subsequent elements, reinforcing a clean and organized layout.
...
These styling options help ensure your Text components are visually consistent with your design while maintaining readability for users.

# Logic[](#logic)

Persona provides you with the ability to add logic to a Text component. For example, a component may only become visible to a user if certain conditions are met. There are two options for logic rules:
...
1.  Click on the Text component, and go to **Logic** in the Right Panel.
...
## Text component by plan[](#text-component-by-plan)

|  | Startup Program | Essential Plan | Growth Plan | Enterprise Plan |
| --- | --- | --- | --- | --- |
| Text component | Available | Available | Available | Available |
| Translations for Text component | Available | Available | Available | Available |
| Styles for Text component | Available | Available | Available as part of Inquiries Enhanced | Available as part of Inquiries Enhanced |
| Logic for Text component | Not Available | Not Available | Available as part of Inquiries Enhanced | Available as part of Inquiries Enhanced |
