# Understanding Phone Number Verification results[](#understanding-phone-number-verification-results)

## Overview[](#overview)

The Phone Number Verification verifies the ownership of an inputted phone number with two-factor authentication via text. For more details, see the [Phone Number Verification overview](./5tWkS5L9FJclUINe6kZtz7.md).

This page examines an example of a Phone Number Verification and guides you through the results. You'll learn how to interpret Verification checks and understand why they **passed** or **failed**.
...
## Example Phone Number Verification run result[](#example-phone-number-verification-run-result)

As an example, we'll look at a Phone Number Verification. We'll walk through the example Verification below, section by section.

![Phone2FA](../images/Phone2FA_24cda1b760ce.png)
...
When viewing a Phone Number Verification run, you’ll first see the overall Verification result. In this example, the Phone Number Verification **passed**.
...
“Phone Number” refers to the Phone number submitted.

### Attempts[](#attempts)

“Attempts” refers to the number of attempts to submit a phone number.
...
[Phone Number Verification](./5tWkS5L9FJclUINe6kZtz7.md)
