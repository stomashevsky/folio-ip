# Inquiries: Text Input component

# What is the Inquiry Text Input component?[](#what-is-the-inquiry-text-input-component)

**Text Input** is an Inquiry screen component that adds a text field to the screen. It allows users to enter and edit freeform text. You can set how the input data is updated to the fields table and define logic that governs when it appears.

![textinput](../images/TextInputComponent_7546ae6dbc30.png)

An **Text Input** component is useful for collecting short, freeform text from users. For example, a Text Input component can be used to collect a contact email address.

# How do you add an Inquiry Text Input component?[](#how-do-you-add-an-inquiry-text-input-component)
...
4.  In the Left Panel, click **Component Library** and search for ‘**Text Input**’.
5.  Drag and drop the Text Input component into your screen, and reposition it by dragging it around.
6.  Click on the Text Input component, and go to **Properties** in the Right Panel.
    1.  (Optional) Under **Settings**, you can change the **Input Type** to fit the expected data.
        1.  **Text** for general input
        2.  **Email** for email addresses
        3.  **Number pad** for numeric entries.
    2.  (Optional) Under **Settings**, you can define **Restricted Characters** to block specific characters from being entered, ensuring the input meets your formatting or security requirements.
    3.  (Optional) Under **Settings**, you can customize **Validations.** You can learn more about **Validations** below.
    4.  (Optional) Add a customized **label**, **placeholder** and **translations**:
        1.  Edit the text in the **Label** box. The **Label** is a text element displayed above the Text Input component to describe its purpose, such as “Enter an email address” or “Provide more information,” helping users understand what information to provide.
        2.  Edit the text in the **Placeholder** box. The **Placeholder** displays temporary text inside the Text Input component, such as “[example@email.com](mailto:example@email.com)” offering an example or guidance on the expected format until the user enters their own input.
...
7.  In the **[Fields](./5rT2Llik2kUvJTXKapZb8c.md)** tab, you can set up and customize the behavior of the Text Input component.
    ...
    2.  **Field:** Choose the field to save the text input to. For example, select an email address field if the user is expected to input an email address.
...
Validation rules can be set on a Text Input field to ensure that the entered data is a properly formatted and is valid. This can prevent errors such as invalid inputs, and can ensure only usable and accurate text is submitted.

The **Error message** can be edited to provide the user with more information on why the text is not valid. Translations for the error message can be added by clicking **Edit translations.** You can **Translate All** or **Translate** individual languages, manually or automatically. If you don’t set translations, you’ll be prompted to do so upon **Publishing** the template.
...
1.  Click on the Text Input component, and go to **Logic** in the Right Panel.
...
Persona provides you with the ability to add logic to a Text Input component. For example, a component may only become visible to a user if certain conditions are met. On the **Logic** tab, there are two options for logic rules:
...
## Text Input component by plan[](#text-input-component-by-plan)

|  | Startup Program | Essential Plan | Growth Plan | Enterprise Plan |
| --- | --- | --- | --- | --- |
| Text Input component | Available | Available | Available | Available |
| Validations for Text Input component | Available | Not Available | Available | Available |
| Translations for Text Input component | Available | Available | Available | Available |
| Logic for Text Input component | Not Available | Not Available | Available as part of Inquiries Enhanced | Available as part of Inquiries Enhanced |
