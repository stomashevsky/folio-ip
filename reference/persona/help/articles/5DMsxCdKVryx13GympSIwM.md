# Inquiries: Checkbox component

# What is the Inquiry Checkbox component?[](#what-is-the-inquiry-checkbox-component)
...
![checkbox](../images/CheckboxComponent_d75e06ffc6b8.png)
...
# How do you add an Inquiry Checkbox component?[](#how-do-you-add-an-inquiry-checkbox-component)
...
4.  In the Left Panel, click **Component Library** and search for ‘**Checkbox**’.
5.  Drag and drop the Checkbox component into your screen, and reposition it by dragging it around.
6.  Click on the Checkbox component, and go to **Properties** in the Right Panel.
...
7.  (Optional) In the **Styles** tab, you can edit the **Checkbox’s** text styling, including setting the font family, and color. You can read more about **Styles** below.
8.  In the **[Fields](./5rT2Llik2kUvJTXKapZb8c.md)** tab, you can set up and customize the behavior of the Checkbox component.
9.  **Required**: Choose whether the field is mandatory (**Yes)**, optional (**No**), or based on conditions (**Conditional**). If you choose **Conditional** you will need to set a Logic rule, you can read more about **Logic** below.
10.  (Optional) In the **Logic** tab, you can add rules that govern when the component appears, and when it does not. You can read more about **Logic** below.
11.  **Close** the step. You’ll have to **Save** and **Publish** the template to begin using it.
...
Persona provides you with the ability to add logic to a Checkbox component. For example, a component may only become visible to a user if certain conditions are met. On the **Logic** tab, there are two options for logic rules:
...
## Checkbox component by plan[](#checkbox-component-by-plan)

|  | Startup Program | Essential Plan | Growth Plan | Enterprise Plan |
| --- | --- | --- | --- | --- |
| Checkbox component | Available | Available | Available | Available |
| Validations for Checkbox component | Available | Available | Available | Available |
| Translations for Checkbox component | Available | Available | Available | Available |
| Styles for Checkbox component | Available | Available | Available | Available |
