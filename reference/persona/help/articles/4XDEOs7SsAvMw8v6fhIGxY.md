# Inquiries: Phone Number component

# What is the Inquiry Phone Number component?[](#what-is-the-inquiry-phone-number-component)

**Phone Number** is an Inquiry screen component that adds a form component designed for users to enter a valid phone number.

![PhoneNumberComponent](../images/PhoneNumberComponent_353e78f236a3.png)

The **Phone Number** input component is useful for collecting phone number’s from a user.

# How do you add an Inquiry Phone Number component?[](#how-do-you-add-an-inquiry-phone-number-component)
...
4.  In the Left Panel, click **Component Library** and search for ‘**Phone Number**’.
5.  Drag and drop the Phone Number component into your screen, and reposition it by dragging it around.
6.  Click on the Phone Number component, and go to **Properties** in the Right Panel.
    1.  (Optional) Under **Settings**, you can customize **Validations.** Default validations include country code selection and input format validation. You can learn more about adding additional **Validations** below.
    2.  (Optional) Add a customized **label**, **placeholder** and **translations**:
        1.  Edit the text in the **Label** box. The **Label** is a text element displayed above the Phone Number component to describe its purpose, such as “Enter your Phone Number,” helping users understand what information to provide.
        2.  Edit the text in the **Placeholder** box. The **Placeholder** displays temporary text inside the Phone Number input component, such as “(555) 555-5555” offering an example or guidance on the expected format until the user enters their own input.
...
7.  In the **[Fields](./5rT2Llik2kUvJTXKapZb8c.md)** tab, you can set up and customize the behavior of the Phone Number component.
    ...
    2.  **Field:** Choose the field to save the Phone Number to. For example, select a phone number field if the user is expected to input an phone number.
    3.  (Optional) **Max length (char):** This sets the maximum length of characters accepted for this input field. The default value is 1024 characters.
...
Validation rules can be set on a Phone Number field to ensure that the entered data is a properly formatted and is a valid phone number. This can prevent errors such as an incomplete phone number, and can ensure only usable and accurate phone numbers are submitted.

The **Error message** can be edited to provide the user with more information on why the Phone Number is not valid. Translations for the error message can be added by clicking **Edit translations.** You can **Translate All** or **Translate** individual languages, manually or automatically. If you don’t set translations, you’ll be prompted to do so upon **Publishing** the template.
...
1.  Click on the Phone Number component, and go to **Logic** in the Right Panel.
...
Persona provides you with the ability to add logic to a Phone Number component. For example, a component may only become visible to a user if certain conditions are met. On the **Logic** tab, there are two options for logic rules:
...
## Phone Number component by plan[](#phone-number-component-by-plan)

|  | Startup Program | Essential Plan | Growth Plan | Enterprise Plan |
| --- | --- | --- | --- | --- |
| Phone Number component | Available | Available | Available | Available |
| Validations for Phone Number component | Available | Available | Available | Available |
| Translations for Phone Number component | Available | Available | Available | Available |
| Logic for Phone Number component | Not Available | Not Available | Available as part of Inquiries Enhanced | Available as part of Inquiries Enhanced |
