# Inquiries: Select component

# What is the Inquiry Select component?[](#what-is-the-inquiry-select-component)

**Select** is an Inquiry screen component that adds a dropdown component to the screen. It allows users to choose one option from a predefined list. It simplifies decision-making by presenting options in a compact, scrollable format.

![select](../images/SelectComponentCorrect_a624a4c50891.png)

A Select component is ideal for scenarios like choosing a country, selecting a category, or picking a date range, ensuring users can only select valid inputs.

# How do you add an Inquiry Select component?[](#how-do-you-add-an-inquiry-select-component)
...
4.  In the Left Panel, click **Component Library** and search for ‘**Select**’.
5.  Drag and drop the Select component into your screen, and reposition it by dragging it around.
6.  Click on the Select component, and go to **Properties** in the Right Panel.
    ...
    2.  (Optional) Add a customized **label**, **placeholder** and **translations**:
        1.  Edit the text in the **Label** box. The **Label** is a text element displayed above the Select component to describe its purpose, such as “Select Country” helping users understand what information to provide.
        2.  Edit the text in the **Placeholder** box. The **Placeholder** displays temporary text inside the Select component, such as “Canada” offering an example or guidance on the expected format until the user enters their own input.
...
7.  In the **[Fields](./5rT2Llik2kUvJTXKapZb8c.md)** tab, you can set up and customize the behavior of the Select component.
...
![selectoptions](../images/selectoptions_d830ad68b9a1.png)
...
Validation rules can be set on a Select component to ensure that the entered data is a properly formatted and is a valid. This can prevent errors such as invalid inputs, and can ensure only usable and accurate selections are submitted.

The **Error message** can be edited to provide the user with more information on why the selection is not valid. Translations for the error message can be added by clicking **Edit translations.** You can **Translate All** or **Translate** individual languages, manually or automatically. If you don’t set translations, you’ll be prompted to do so upon **Publishing** the template.
...
1.  Click on the Select component, and go to **Logic** in the Right Panel.
...
Persona provides you with the ability to add logic to a Select component. For example, a component may only become visible to a user if certain conditions are met. On the **Logic** tab, there are two options for logic rules:
...
## Select component by plan[](#select-component-by-plan)

|  | Startup Program | Essential Plan | Growth Plan | Enterprise Plan |
| --- | --- | --- | --- | --- |
| Select component | Available | Available | Available | Available |
| Validations for Select component | Available | Available | Available | Available |
| Translations for Select component | Available | Available | Available | Available |
| Logic for Select component | Not Available | Not Available | Available as part of Inquiries Enhanced | Available as part of Inquiries Enhanced |
