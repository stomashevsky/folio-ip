...
If you don’t want certain information to get to your server, you can filter out information via [API Key](./api-keys.md) attribute blocklists. To view and edit a particular blocklist, visit your [API Keys](https://app.withpersona.com/dashboard/api-keys) page and click into a particular API key to view its configuration.

![api-attribute-blocklists](./images/api-attribute-blocklists_4bdda6279d7a.png)

## Example

Let’s say you get the following information when you retrieve your Inquiry (via [Retrieve an Inquiry](./api-reference/inquiries/retrieve-an-inquiry.md)).
