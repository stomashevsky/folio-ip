...
-   🌱 **Set SLA when updating or creating a Case**: You can now set SLAs using `meta.sla-expires-in-seconds` on the [Create a Case](../../../../cases/create-a-case.md) and [Update a Case](../../../../cases/update-a-case.md) APIs.
