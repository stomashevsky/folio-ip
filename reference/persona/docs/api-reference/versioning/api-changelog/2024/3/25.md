...
-   🌱 **Create passed or failed Verifications when simulating Inquiries**: We’ve added two new actions to the [Inquiries perform simulate actions API](../../../../inquiries/perform-simulate-actions.md) that allow you to simulate specific Verification statuses. For more info on testing integrations using sandbox inquiries, see the [guide](../../../../../integration-testing.md).
