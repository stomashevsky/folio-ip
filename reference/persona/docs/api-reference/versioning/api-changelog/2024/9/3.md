...
[September 3, 2024](./3.md)

[September 3, 2024](./3.md)

### Inquiries

-   🍃 **Add new attributes to Inquiry Sessions**: Inquiry Session resources (such as those returned by the [retrieve an Inquiry Session API](../../../../inquiry-sessions/retrieve-an-inquiry-session.md)) now include three new attributes: `gps-latitude`, `gps-longitude` and `gps-precision`.
