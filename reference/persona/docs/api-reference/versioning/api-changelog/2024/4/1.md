...
-   🌱 **Set tags on Inquiry creation and update**: You can now pass in a set of `tags` to be added to the Inquiry when you call the [Create an Inquiry](../../../../inquiries/create-an-inquiry.md) or [Update an Inquiry](../../../../inquiries/update-an-inquiry.md) APIs.
