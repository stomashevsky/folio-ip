...
[June 17, 2024](../6/17.md)

[June 17, 2024](../6/17.md)

### Cases

-   🌱 **Add Case Queue to Cases create and update endpoints**: You can now add or remove a Case from a Case Queue via the [create a Case](../../../../cases/create-a-case.md) and [update a Case](../../../../cases/update-a-case.md) APIs with the `case-queue-id` parameter. Case objects in all API responses will now include `case-queue` in `data.relationships`.
