...
-   🌱 **Filter by identifiers in Transaction list API**: You can now filter by identifiers using the [list all Transactions API](../../../../transactions/list-all-transactions.md). The allowed keys are dependent on your Transaction Type configurations.
