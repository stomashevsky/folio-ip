...
[February 18, 2025](./18.md)

[February 18, 2025](./18.md)

### Verifications

-   🍃 **Add `from-reusable-persona` attribute to Government ID and Selfie Verifications**: Government ID and Selfie Verification resources now include a `from-reusable-persona` boolean attribute, which indicates whether or not the verification data was submitted via a [Reusable Persona](https://help.withpersona.com/articles/4DXUhrP7e1sLBj2SKIDsMX/).
