...
[October 23, 2023](./23.md)

[October 23, 2023](./23.md)

### Inquiries

-   🌱 **Inquiries “simulate actions” Endpoint**: The new [Perform Simulate Actions](../../../../inquiries/perform-simulate-actions.md) endpoint lets you [Simulate Inquiry Actions](../../../../../integration-testing.md).
-   🍃 **Add `updated-at` to Inquiries attributes**: The Inquiry model now shows when it was last modified.

### API Keys & Webhooks

-   🌱 **Attribute Blocklist Exceptions** Exclude entries from the [API/Webhook Attribute Blocklists](../../../../../webhook-attribute-blocklists.md#attribute-blocklist).
