...
[October 10, 2023](./10.md)

[October 10, 2023](./10.md)

### OAuth

-   🔧 **Use key inflection with OAuth endpoints**: The [Create Authorization](../../../../oauth/create-authorization.md) and [Create Access Token](../../../../oauth/create-access-token.md) endpoints now honor the `Key-Inflection` header or [API Key](../../../../../api-keys.md) configuration. Before this fix, the endpoints were only responding with `snake_case` inflection.
