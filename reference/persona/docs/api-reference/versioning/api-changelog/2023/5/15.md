...
-   🍃 **Dismiss a Business Adverse Media Report match**: You can now dismiss a Report match for the Business Adverse Media Report type. Use the existing [Dismiss a Report](../../../../reports/dismiss-matches.md) API, and pass a Business Adverse Media Report ID.
