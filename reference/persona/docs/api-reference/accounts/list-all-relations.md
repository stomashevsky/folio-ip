...
https://api.withpersona.com/api/v1/accounts/:account-id/relations
...
```
{
  ...
  "links": {
    "prev": "/api/v1/accounts/act_ABC123/relations?filter%5Bkey%5D=my_relation&page%5Bafter%5D=act_XYZ987",
