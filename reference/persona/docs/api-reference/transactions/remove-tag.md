...
https://api.withpersona.com/api/v1/transactions/:transaction-id/remove-tag

ExampleSuccess

POST

/api/v1/transactions/:transaction-id/remove-tag
...
url = "https://api.withpersona.com/api/v1/transactions/transaction-id/remove-tag"
...
ID of the transaction to remove tag from.
